    ...
    <main style={{ marginTop: "64px", height: "100%" }}>
      ...
      <div className="intro-container">
        <div className="intro-area">
          ...
          <p>
            {" "}
            The multimillion dollar company and its partners serve more than 400
            corporations, institutions and home users in the United States,
            Canada, the Caribbean, Latin America, Europe, the Middle East &
            Africa.
          </p>
        </div>
        ...
        <div className="intro-area">
          ...
          <p>
            ...
            of the world's leading hardware & software manufacturers.
          </p>
          <p>
            {" "}
            Guaranteed same-day shipping until 5 p.m. More than 95-percent
            shipping accuracy.
          </p>
          <p>
            {" "}
            Expert Sales Consultants and education. Value-added services,
            including integration, configuration, assembly, electronic
      ...
      <div className="home-page-content">
        ...
        <div className="container">
          <div className="text-area">
            ...
            <p className="spanish-call-to-action">
              Para pedir una cotizacion<br></br> en Espanol, escribenos
            </p>
            <a className="email" href="mailto:tere@shopbti.com">
              Email Ventas
            </a>
